    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GenButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String data = AssetID.getText().toString();

                if (data.length()!=9){
                    Toast.makeText(GenerateActivity.this, "Valid Asset Identifier is 9 Digits Long ", Toast.LENGTH_SHORT).show();
                }else{
                    ...
                    Intent i = new Intent(GenerateActivity.this,Register.class);
                    startActivity(i);
                }
            }
        });
        Save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    String savePath = Environment.getExternalStorageDirectory().getPath() + "/QRCode/";
                     save = qrgSaver.save(savePath,AssetID.getText().toString().trim(),
                            bitmap,QRGContents.ImageType.IMAGE_JPEG);
                     result = save ? "QR saved":"Failed Save";
                    Toast.makeText(GenerateActivity.this, result, Toast.LENGTH_LONG).show();
                }catch(Exception e){
                    e.printStackTrace();
                }
            }
